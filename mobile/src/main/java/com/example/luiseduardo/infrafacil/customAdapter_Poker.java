...
public class customAdapter_Poker extends RecyclerView.Adapter<customAdapter_Poker.ViewHolder> implements MyDialogFragment.DialogListener {

    private  List<JogosListView> list;
    ...
    private static customAdapter_Poker mAdapter;
    ...
    public customAdapter_Poker(List<JogosListView> list, int rowLayout, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder myViewHolder, int position) {
        final JogosListView city = list.get(position);

       // myViewHolder.title.setText( city.getDescricao());
        //myViewHolder.title.setText( list.get(position));
        //myViewHolder.tv_id.setText(city.getId());
        myViewHolder.tv_Descricao.setText(city.getDescricao());
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private String tv_vladdon;
        private String tv_qtdfichaaddon;
        private TextView tv_qtdplayers;
        private String tv_image_path;
        ...
        public ViewHolder(View view) {
            ...
            //tv_id = (TextView) itemView.findViewById(R.id.idplayer);
            tv_Descricao = (TextView) itemView.findViewById(R.id.tvdescrijogo);
            tv_Data = (TextView)itemView.findViewById(R.id.tvdatajogo);
            tv_qtdplayers = (TextView)itemView.findViewById(R.id.tvqtdplayers);
            tv_image = (CircleImageView) itemView.findViewById(R.id._imagem_prod);
    ...
    public class GetDados extends AsyncTask<Void, Void, Void> {
            ...
            if (success == 1) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        if (valor != null) {
                            //PLAYERS = true;
                            //CalendarActivity.lsjogo.add(new JogosListView(id, idjogo1, name,  rebuy,  addon, valor,vlentrada,vlrebuy,vladdon,1,img));
                        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (PLAYERS) {
                ...
                CalendarActivity.recyclerView.setLayoutManager(gridLayoutManager);
                CalendarActivity.recyclerView.setItemAnimator(new DefaultItemAnimator());
                CalendarActivity.mAdapter = new customAdapter_Poker(lsjogo, R.layout.item_players, mContext);
                CalendarActivity.recyclerView.setAdapter(CalendarActivity.mAdapter);
